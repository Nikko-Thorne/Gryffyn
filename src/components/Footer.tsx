      ...
      <div className="max-w-6xl mx-auto px-4">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 bg-gray-700 hover:bg-green-600 rounded-full flex items-center justify-center transition-all duration-300 transform hover:scale-110"
        ...
        <div className="border-t border-gray-800 pt-8 text-center">
          ...
          <p className="text-gray-400 text-sm mt-2">
            Powered by <a href="https://techton.cloud/" target="_blank" rel="noopener noreferrer" className="text-blue-300 hover:text-blue-200 transition-colors duration-200">Techton</a>
          </p>
        </div>
      </div>
    </footer>
